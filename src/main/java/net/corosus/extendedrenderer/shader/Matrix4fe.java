...
public class Matrix4fe {
    ...
    public Matrix4fe(Matrix4fe mat) {
        this.setMatrix4fe(mat);
        this.properties = mat.properties();
    }

    public static void get(Matrix4fe m, int offset, FloatBuffer src) {
    ...
    public static double cosFromSin(double sin, double angle) {
        ...
        if (b < 0.0D) b += 6.283185307179586D;
    ...
    public static Matrix4fe fromMatrix4f(Matrix4f mat) {
        Matrix4fe dest = new Matrix4fe();
    ...
    private void setMatrix4fe(Matrix4fe mat) {
        this._m00(mat.m00());
        this._m01(mat.m01());
        this._m02(mat.m02());
        this._m03(mat.m03());
    ...
    private Matrix4fe rotateGeneric(float ang, float x, float y, float z, Matrix4fe dest) {
        ...
        float c = (float) cosFromSin(s, ang);
        float C = 1.0F - c;
        float xx = x * x, xy = x * y, xz = x * z, yy = y * y, yz = y * z, zz = z * z;
        float rm00 = xx * C + c, rm01 = xy * C + z * s, rm02 = xz * C - y * s;
        float rm10 = xy * C - z * s, rm11 = yy * C + c, rm12 = yz * C + x * s;
        float rm20 = xz * C + y * s, rm21 = yz * C - x * s, rm22 = zz * C + c;
    ...
    public Matrix4fe rotation(float angle, float x, float y, float z) {
        ...
        float cos = (float) cosFromSin(sin, angle);
        float C = 1.0F - cos;
    ...
    public Matrix4fe rotateAffine(float ang, float x, float y, float z) {
    ...
    public Matrix4fe rotateX(float ang, Matrix4fe dest) {
        if ((this.properties & 4) != 0) {
            ...
            float cos = (float) cosFromSin(sin, ang);
            float rm21 = -sin;
    ...
    public FloatBuffer get(int index, FloatBuffer buffer) {
        if (index == 0) this.put0(buffer);
        else this.putN(index, buffer);
        return buffer;
    }

    private void putN(int offset, FloatBuffer dest) {
        dest.put(offset, m00);
        dest.put(offset + 1, m01);
        dest.put(offset + 2, m02);
        dest.put(offset + 3, m03);
        dest.put(offset + 4, m10);
        dest.put(offset + 5, m11);
        dest.put(offset + 6, m12);
        dest.put(offset + 7, m13);
        dest.put(offset + 8, m20);
        dest.put(offset + 9, m21);
        dest.put(offset + 10, m22);
        dest.put(offset + 11, m23);
        dest.put(offset + 12, m30);
        dest.put(offset + 13, m31);
        dest.put(offset + 14, m32);
        dest.put(offset + 15, m33);
    }

    private void put0(FloatBuffer dest) {
        dest.put(0, m00);
        dest.put(1, m01);
        dest.put(2, m02);
        dest.put(3, m03);
    ...
    public Matrix4fe transpose3x3(Matrix4fe dest) {
        float nm00 = this.m00, nm01 = this.m10, nm02 = this.m20;
        float nm10 = this.m01, nm11 = this.m11, nm12 = this.m21;
        float nm20 = this.m02, nm21 = this.m12, nm22 = this.m22;
        dest._m00(nm00);
        dest._m01(nm01);
        dest._m02(nm02);
        dest._m10(nm10);
    ...
    public Matrix4fe translationRotateScale(
